...
//          para          name                  value      dtype         scale   unit      row  col      screen
    {   __SC1_EC,         "EC       : ",       NULL,   _DTYPE_I32,   0xFE,      NULL,      0,  4,  0x00,      _LCD_SCREEN_1  },
    {   __SC1_TDS,        "TDS      : ",       NULL,   _DTYPE_I32,   0xFE,      NULL,      1,  4,  0x00,      _LCD_SCREEN_1  },
    {   __SC1_SALINITY,   "Salinity : ",       NULL,   _DTYPE_I32,   0xFE,      NULL,      2,  4,  0x00,      _LCD_SCREEN_1  },
    {   __SC1_TEMP,       "Temp     : ",       NULL,   _DTYPE_I32,   0xFE,      NULL,      3,  4,  0x00,      _LCD_SCREEN_1  },
    ...
    {   __SET_OFFSET_EC,        "1.EC      : ",       NULL,    _DTYPE_I32,     0xFE,   NULL,       1,  14, 0x00,    _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_TDS,       "2.TDS     : ",       NULL,    _DTYPE_I32,     0xFE,   NULL,       2,  14, 0x00,    _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_SALINITY,  "3.Salinity: ",       NULL,    _DTYPE_I32,     0xFE,   NULL,       3,  14, 0x00,    _LCD_SCR_SET_OFFSET},
    {   __SET_OFFSET_TEMP,      "4.Temp    : ",       NULL,    _DTYPE_I32,     0xFE,   NULL,       4,  14, 0x00,    _LCD_SCR_SET_OFFSET},
...
void Update_ParaDisplay(void)
{
    ...
    sParaDisplay.EC_Value_i32 = (int32_t)(sSensor_EC.EC_Value_f*100);
    ...
    sParaDisplay.EC_Filter_i32 = (int32_t)(sSensor_EC.EC_Filter_f*100);
    ...
    sParaDisplay.EC_Offset_i32   = (int32_t)(sSensor_EC.EC_Offset_f*100);
