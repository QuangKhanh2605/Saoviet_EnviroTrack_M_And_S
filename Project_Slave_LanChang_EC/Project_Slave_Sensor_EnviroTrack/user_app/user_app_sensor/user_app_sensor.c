...
void Handle_Data_Measure(uint8_t KindRecv)
{
    switch(KindRecv)
    {
        case _RS485_SS_EC_OPERA:
            ...
            sSensor_EC.EC_Value_f = quickSort_Sampling_Value((int32_t)(sSensor_EC.EC_Value_f));
            
            sSensor_EC.EC_Filter_f = Filter_EC(sSensor_EC.EC_Value_f);
            sSensor_EC.TDS_Filter_f = Filter_TDS(sSensor_EC.TDS_Value_f);
            sSensor_EC.Salinity_Filter_f = Filter_Salinity(sSensor_EC.Salinity_Value_f);
    ...
    if(sSensor_EC.State_Connect == _SENSOR_DISCONNECT)
    {
        ...
        sSensor_EC.EC_Filter_f = Filter_Temp(sSensor_EC.temp_Value_f);;
    }
}
...
float Filter_EC(float var)
{
    return var;
}

float Filter_TDS(float var)
{
    return var;
}

float Filter_Salinity(float var)
{
    return var;
}
...
//          sSensor_EC.sTemperature_Value.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_EC.sTemperature_Value.Scale);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_EC.temp_Value_f);
          
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
//          sSensor_EC.sTDS_Value.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_EC.sTDS_Value.Scale);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_EC.TDS_Value_f);
...
//          sSensor_EC.sSalinity_Value.Value = Stamp_i32/10000;
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_EC.Salinity_Value_f);
          sSensor_EC.Salinity_Value_f = sSensor_EC.Salinity_Value_f/10000;
          break;
        ...
        case _RS485_SS_EC_CALIB_READ_DATA:
          ...
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_EC.EC_Calib_Const_f);
          break;
...
//        sSensor_EC.sResistivity_Value.Value = 0;
        ...
        sSensor_EC.EC_Calib_Const_f = 0;
        sSensor_EC.EC_Calib_Value_f = 0;
...
/*===================Save and Init Calib====================*/
void Save_ParamCalib(float EC_Offset_f, float TDS_Offset_f, float Salinity_Offset_f, float temp_Offset_f)
{
    ...
    uint32_t hexUnit_Compensation_TDS = 0;
    uint32_t hexUnit_Compensation_Salinity = 0;
    uint32_t hexUint_Compensation_temp = 0;
    
    sSensor_EC.EC_Offset_f = EC_Offset_f;
    sSensor_EC.TDS_Offset_f = TDS_Offset_f;
    sSensor_EC.Salinity_Offset_f = Salinity_Offset_f;
    sSensor_EC.temp_Offset_f = temp_Offset_f;
    
    hexUint_Compensation_EC = Handle_Float_To_hexUint32(sSensor_EC.EC_Offset_f);
    hexUnit_Compensation_TDS = Handle_Float_To_hexUint32(sSensor_EC.TDS_Offset_f);
    hexUnit_Compensation_Salinity = Handle_Float_To_hexUint32(sSensor_EC.Salinity_Offset_f);
    ...
    aData[length++] = hexUnit_Compensation_TDS >> 24;
    aData[length++] = hexUnit_Compensation_TDS >> 16;
    aData[length++] = hexUnit_Compensation_TDS >> 8;
    aData[length++] = hexUnit_Compensation_TDS ;
    
    aData[length++] = hexUnit_Compensation_Salinity >> 24;
    aData[length++] = hexUnit_Compensation_Salinity >> 16;
    aData[length++] = hexUnit_Compensation_Salinity >> 8;
    aData[length++] = hexUnit_Compensation_Salinity ;
...
void Init_ParamCalib(void)
{
#ifdef USING_APP_SENSOR
    uint32_t hexUint_Compensation_EC = 0;
    uint32_t hexUint_Compensation_TDS = 0;
    uint32_t hexUint_Compensation_Salinity = 0;
    uint32_t hexUint_Compensation_temp = 0;
    ...
    if(*(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE) != FLASH_BYTE_EMPTY)
    {
        ...
        hexUint_Compensation_TDS  = *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+6) << 24;
        hexUint_Compensation_TDS  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+7)<< 16;
        hexUint_Compensation_TDS  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+8)<< 8;
        hexUint_Compensation_TDS  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+9);
        
        hexUint_Compensation_Salinity  = *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+10) << 24;
        hexUint_Compensation_Salinity  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+11)<< 16;
        hexUint_Compensation_Salinity  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+12)<< 8;
        hexUint_Compensation_Salinity  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+13);
        
        hexUint_Compensation_temp  = *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+14) << 24;
        hexUint_Compensation_temp  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+15)<< 16;
        hexUint_Compensation_temp  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+16)<< 8;
        hexUint_Compensation_temp  |= *(__IO uint8_t*)(ADDR_CALIB_TEMPERATURE+17);
        
        Convert_uint32Hex_To_Float(hexUint_Compensation_EC,  &sSensor_EC.EC_Offset_f);
        Convert_uint32Hex_To_Float(hexUint_Compensation_TDS,  &sSensor_EC.TDS_Offset_f);
        Convert_uint32Hex_To_Float(hexUint_Compensation_Salinity,  &sSensor_EC.Salinity_Offset_f);
    ...
    else
    {
        ...
        sSensor_EC.Salinity_Offset_f = 0;
