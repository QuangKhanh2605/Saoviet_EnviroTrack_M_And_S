...
//    AppCtrlOxy_Packet_Data(pData, &length, OBIS_STATE_PUMP_PH, &sParamCtrlPH.StateCtrl, 1, 0xAA);
        ...
        if(sDataSensorMeasure.sClo.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_CLO_DU, &sDataSensorMeasure.sClo.Value_i32, 2, sDataSensorMeasure.sClo.Scale_u8);
        ...
        if(sDataSensorMeasure.sTurb.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_NTU, &sDataSensorMeasure.sTurb.Value_i32, 2, sDataSensorMeasure.sTurb.Scale_u8);
        
        //----------  SALINITY %------
        if(sDataSensorMeasure.sSal.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_SALINITY_UNIT, &sDataSensorMeasure.sSal.Value_i32, 2, sDataSensorMeasure.sSal.Scale_u8);
        ...
        if(sDataSensorMeasure.sEC.State_u8 == 1)
            SensorRS485_Packet_Data(pData, &length, OBIS_ENVI_EC, &sDataSensorMeasure.sEC.Value_i32, 2, sDataSensorMeasure.sEC.Scale_u8);
