...
sData   sModelVersion = {(uint8_t *) "SV_ENVI_LC_TDS", 14}; 
...
//          para          name                  value      dtype         scale   unit      row  col      screen
    {   __SC1_TITLE,      "TDS.",        NULL,   _DTYPE_STRING,   0,      NULL,      0,  0,  0x00,      _LCD_SCREEN_1  },
    {   __SC1_TDS,         NULL,         NULL,   _DTYPE_I32,   0,      " mg/L", 4,  0,  0x00,      _LCD_SCREEN_1  },
