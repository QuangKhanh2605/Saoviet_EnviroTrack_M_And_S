...
//          para          name                  value      dtype         scale   unit      row  col      screen
    {   __SC1_TURB,     "PH_ATC: ",       NULL,   _DTYPE_STRING,   0xFE,      NULL,      0,  4,  0x00,      _LCD_SCREEN_1  },
    ...
    {   __SET_OFFSET_TURB,  "1.Turb : ",       NULL,   _DTYPE_I32,     0xFE,   NULL,       1,  14, 0x00,    _LCD_SCR_SET_OFFSET},
...
void Display_Init (void)
{
    ...
    sLCDObject[__SET_TUR_TITLE_1].pData      = &sSensor_Turb.Measure_AD;
    ...
    sLCDObject[__SET_TUR_TITLE_2].pData      = &sSensor_Turb.Measure_AD;
