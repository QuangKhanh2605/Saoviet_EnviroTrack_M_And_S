...
{
    .Trans = _RS485_SS_TURBIDITY_OPERA,
};
...
/*--------------------Hoi du lieu tu Slave--------------------*/
    ...
    switch (sLCD.sScreenNow.Index_u8)
    {
        ...
        case _LCD_SCR_SET_CALIB_SS_TUR_TAB_2:
          ...
          {
            sKindMode485.Trans = _RS485_SS_TURBIDITY_OPERA;
          }
          break;
...
static uint8_t fevent_handle_state_sensor(uint8_t event)
{
    ...
    {
        if((sLCD.sScreenNow.Index_u8 == _LCD_SCR_SET_CALIB_SS_TUR_TAB_2) || 
           (sLCD.sScreenNow.Index_u8 == _LCD_SCR_CHECK_SETTING && sLCD.sScreenBack.Index_u8 == _LCD_SCR_SET_CALIB_SS_TUR_TAB_1) ||
           (sLCD.sScreenNow.Index_u8 == _LCD_SCR_SET_CALIB_SS_TUR_TAB_2) || 
           (sLCD.sScreenNow.Index_u8 == _LCD_SCR_CHECK_SETTING && sLCD.sScreenBack.Index_u8 == _LCD_SCR_SET_CALIB_SS_TUR_TAB_2))
...
void Handle_Data_Trans_SS_Turb(sData *sFrame, uint8_t KindTrans)
{
    switch(KindTrans)
    {
        //Send Opera
        case _RS485_SS_TURBIDITY_OPERA:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x03, 0x0001, 0x04);
            break;
            
        //Send Calib
        case _RS485_SS_TUR_CALIB_READ_MEASURE_AD:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x03, 0x0018, 0x02);
            break; 
            
        case _RS485_SS_TUR_CALIB_READ_POINT_CALIB:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x03, 0x0029, 0x10);
            break;
            
        case _RS485_SS_TUR_CALIB_1ST_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0029, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_1ST_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x002B, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_2ND_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x002D, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_2ND_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x002F, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_3RD_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0031, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_3RD_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0033, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_4TH_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0035, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_4TH_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0037, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
...
//          sSensor_Turbidity.sNTU_Value.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sNTU_Value.Scale);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_Turb.Turb_Value_f);
...
//          sSensor_Turbidity.sTemperature_Value.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sTemperature_Value.Scale);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_Turb.temp_Value_f);
          break; 
        ...
        case _RS485_SS_TUR_CALIB_READ_MEASURE_AD:
          ...
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.Measure_AD = Handle_HexFloat_To_Int32_Round(Stamp_Hex, 0x00);
          break;
...
//          sSensor_Turbidity.sFirst_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sFirst_Calibration.Scale);  //mS/cm -> uS/cm
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_Turb.First_Value_f);
          
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.First_AD_u32 =  Stamp_Hex;
...
//          sSensor_Turbidity.sSecond_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sSecond_Calibration.Scale);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_Turb.Second_Value_f);
          
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.Second_AD_u32 =  Stamp_Hex;
...
//          sSensor_Turbidity.sThird_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sThird_Calibration.Scale);  //mS/cm -> uS/cm
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_Turb.Third_Value_f);
          
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.Third_AD_u32 =  Stamp_Hex;
...
//          sSensor_Turbidity.sFourth_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sFourth_Calibration.Scale);
          Convert_uint32Hex_To_Float(Stamp_Hex, &sSensor_Turb.Fourth_Value_f);
          
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.Fourth_AD_u32 =  Stamp_Hex;
          break;
...
void Handle_State_SS_Turb(uint8_t KindRecv, uint8_t KindDetect)
{
    ...
    else if(sSensor_Turb.Count_Disconnect >=3)
    {
        ...
        sSensor_Turb.First_Value_f = 0;
        sSensor_Turb.First_AD_u32= 0;
        sSensor_Turb.Second_Value_f = 0;
        sSensor_Turb.Second_AD_u32= 0;
        sSensor_Turb.Third_Value_f = 0;
        sSensor_Turb.Third_AD_u32= 0;
        sSensor_Turb.Fourth_Value_f = 0;
        sSensor_Turb.Fourth_AD_u32= 0;
        
        sSensor_Turb.Measure_AD= 0;
