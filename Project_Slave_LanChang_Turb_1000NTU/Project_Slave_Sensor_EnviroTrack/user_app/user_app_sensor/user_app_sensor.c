...
void Handle_Data_Measure(uint8_t KindRecv)
{
    ...
    switch(KindRecv)
    {
        case _RS485_SS_TURBIDITY_OPERA:
            ...
            sSensor_Turb.Turb_Value_f = quickSort_Sampling_Value((int32_t)(sSensor_Turb.Turb_Value_f*10));
...
void Handle_Data_Trans_SS_Turb(sData *sFrame, uint8_t KindTrans)
{
    switch(KindTrans)
    {
        ...
        case _RS485_SS_TUR_CALIB_READ_MEASURE_AD:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x03, 0x0013, 0x02);
            break; 
            
        case _RS485_SS_TUR_CALIB_READ_POINT_CALIB:
            ModRTU_Master_Read_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x03, 0x0024, 0x08);
            break; 
            
        case _RS485_SS_TUR_CALIB_1ST_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0024, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_1ST_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0026, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_2ND_VALUE:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x0028, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
          
        case _RS485_SS_TUR_CALIB_2ND_AD:
            if(sData_Calib.Length_u16 == 4)
                ModRTU_Master_Write_Frame(sFrame, ID_DEFAULT_SS_TURB, 0x10, 0x002A, (sData_Calib.Length_u16/2), sData_Calib.Data_a8);
            break;
...
//          sSensor_Turbidity.sFirst_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sFirst_Calibration.Scale);  
          ...
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.First_AD_u32 =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, 0x00);  
...
//          sSensor_Turbidity.sSecond_Calibration.Value =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, sSensor_Turbidity.sSecond_Calibration.Scale);
          ...
          Stamp_Hex = Read_Register_Rs485(sDataRS485.Data_a8, &Pos, 4);
          sSensor_Turb.Second_AD_u32 =  Handle_HexFloat_To_Int32_Round(Stamp_Hex, 0x00);  
          break;
